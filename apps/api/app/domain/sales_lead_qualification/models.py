...
class AgenticSalesLeadQualificationSession(Base):
    __tablename__ = "sales_lead_qualification_sessions"
...
class AgenticSalesLeadQualificationItem(Base):
    __tablename__ = "sales_lead_qualification_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("sales_lead_qualification_sessions.id"))
