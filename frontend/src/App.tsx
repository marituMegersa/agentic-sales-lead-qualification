...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI B2B Sales Prospecting & Lead Qualifier</h1>
      <p style={{ color: '#666' }}>Multi-agent B2B prospect enrichment, personalized outreach generator, lead scoring, and CRM synchronization agent.</p>
